...
namespace DSPlus.Examples
{
    public class ExampleUngrouppedCommands
    {
        ...
        [Command("raid")] // let's define this method as a command
        [Description("starts the raid roulette subroutine.")] // this will be displayed to tell users what this command does when they invoke help
        [Aliases("roulette", "rr")] // alternative names for the command
        public async Task Raid(CommandContext ctx) // this command takes no arguments
        {
            // let's trigger a typing indicator to let
            // users know we're working
            await ctx.TriggerTypingAsync();
            ...
            // let's make the message a bit more colourful
            var emoji = DiscordEmoji.FromName(ctx.Client, ":raid:");

            Random rand = new Random();
            int myValue = rand.Next(0, 7);

            //Raid array is stored here. Below are the Retired raids or unavailable for us Raids. 
            string[] myArray = new string[] { "*Leviathan*", "*Spire of Stars*", "*Eater of Worlds*", "*Last Wish*", "*Scourge of the Past*", "*Crown of Sorrows*", "*Garden of Salvation*" };
            //RETIRED RAIDS
            // "**Prestige** *Leviathan*", "**Prestige** *Spire of Stars*", "**Prestige** *Eater of Worlds*", "**Flawless** *Scourge of the Past*", "**Flawless** *Crown of Sorrows*", "**Petra's Run** *Last Wish*",

            // respond with Roulette result
            await ctx.RespondAsync($"{emoji} The Raid Roulette has landed on: {myArray[myValue]} Good Luck Guardians!");

        }

        [Command("embed")] // let's define this method as a command
        [Description("me tring to build an embed.")] // this will be displayed to tell users what this command does when they invoke help
        [Aliases("e", "re")] // alternative names for the command
        public async Task Test1(CommandContext ctx) // this command takes no arguments
        {
            // let's trigger a typing indicator to let
            // users know we're working
            await ctx.TriggerTypingAsync();
            ...
            // Raid array is stored here.
            string[] myArray = new string[] { "*Leviathan*", "*Spire of Stars*", "*Eater of Worlds*", "*Last Wish*", "*Scourge of the Past*", "*Crown of Sorrows*", "*Garden of Salvation*", };
            string raidroulette = myArray[myValue];

            // Image links for Raid Graphics
            //leviathan =               "https://i.imgur.com/6rEBNB3.png"
            //scourge of the past =     "https://i.imgur.com/jDg9uyC.png"
            //Garden of Salvation =     "https://i.imgur.com/hoUWSXZ.png";
            //Spire of Stars =          "https://i.imgur.com/eI34eM0.png";
            //Eater of worlds =         "https://i.imgur.com/dYC4PUr.png";
            //crown of sorrows =        "https://i.imgur.com/PaLreYP.png";
            //Last wish =               "https://i.imgur.com/O0Uf6Vp.jpg";

            string[] graphArray = new string[] { "https://i.imgur.com/6rEBNB3.png", "https://i.imgur.com/eI34eM0.png", "https://i.imgur.com/dYC4PUr.png", "https://i.imgur.com/O0Uf6Vp.jpg", "https://i.imgur.com/jDg9uyC.png", "https://i.imgur.com/PaLreYP.png", "https://i.imgur.com/hoUWSXZ.png", };
            string graphResult = graphArray[myValue];

            //Embed started here
            var embedR = new DiscordEmbedBuilder();
            embedR.AddField("This Random Raid is:", raidroulette, false);

            embedR.WithTitle("**Raid Roulette**");
            //embedR.WithDescription("Test test test [named links](https://discordapp.com) Test test test test test TEST. ```\nyes, does this work```");
            //embedR.WithUrl("https://discordapp.com");
            embedR.WithColor(new DiscordColor(0xD0021B));
            //.WithTimestamp(DateTimeOffset.FromUnixTimeMilliseconds(1578078816123UL));
            //embedR.WithFooter("footer text",
            //    "https://cdn.discordapp.com/embed/avatars/0.png"
            //);
            embedR.WithThumbnailUrl("https://i.imgur.com/fq3GCWN.png");
            embedR.WithImageUrl(graphResult);
            //embedR.AddField("TEST!, "some of these properties have certain limits...", false);
            embedR.AddField("TEST", "*Good Luck Guardians!*", false);
            //embedR.AddField("🙄", "an informative error should show up, and this view will remain as-is until all issues are fixed", false);
            //embedR.AddField("Another Prestige Order", "Figure out the APi?", true);
            //embedR.AddField("Order", "Figure me out in the API", true);

            // respond with Roulette result
            await ctx.RespondAsync(embed: embedR);
        ...
        //THIS IS COMMENTED OUT FOR TESTING GW 2019-11-22 11:18
        //[Command("raid"), Description("Starts the Raid Roulette."), Aliases("RR", "roulette")]
        //public async Task Raid(CommandContext ctx, [Description("Starts the Raid Roulette.")] DiscordMember member) // this command takes a member as an argument; you can pass one by username, nickname, id, or mention
        //{
        //    // note the [Description] attribute on the argument.
        //    // this will appear when people invoke help for the
        //    // command.
        ...
        //    // and finally, let's respond and greet the user.
        //    await ctx.RespondAsync($"{emoji} THIS IS THE RAID ROULETTE, {member.Mention}!");
        //}
